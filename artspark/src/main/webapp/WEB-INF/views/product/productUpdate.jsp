...
<body>
    ...
    <div class="container container-custom mt-5">
        ...
        <form action="${path1 }/product/update" method="post" enctype="multipart/form-data">
            <div class="form-group row">
           	...
           	<script>
           		...
           		$(() => {
           			...
           			var purpose = '${product.productPurpose}';
           			
           			$('#category').val(category);
           			
           			if(purpose === '상업용') {
           				$('#productPurpose1').attr('checked', true);
           			} else if(purpose === '비상업용') {
           				$('#productPurpose2').attr('checked', true);
           			} else {
           				$('#productPurpose1').attr('checked', true);
           				$('#productPurpose2').attr('checked', true);
           			}
            ...
            <div class="form-group row" style="margin-bottom: 60px !important;">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control" id="title" name="productTitle" value="${ product.productTitle }" placeholder="제목을 입력해주세요." required>
            ...
            <div class="form-group row" style="margin-bottom: 80px !important;">
                ...
                <div class="col-sm-3">
                    <input type="file" class="form-control-file" id="mainImage1" name="upImage1" onchange="loadImg(this)" required>
                </div>
                <div class="col-sm-3">
                    <input type="file" class="form-control-file" id="mainImage2" name="upImage2" onchange="loadImg(this)">
                </div>
                <div class="col-sm-3">
                    <input type="file" class="form-control-file" id="mainImage3" name="upImage3" onchange="loadImg(this)">
                </div>
                ...
                <c:set var="productFilesSize" value="${fn:length(productFiles)}" />
                <label for="" class="col-sm-2 col-form-label pre-image"></label>
                <c:if test="${ productFilesSize == 1 }">
                	<c:forEach items="${ productFiles }" var="productFile">
		                <div class="col-sm-3 pre-image">
		                    <img id="preImage1" class="preImage" src="${path1 }/${ productFile.filePath }">
		                </div>
	                </c:forEach>
	                <div class="col-sm-3 pre-image">
                ...
                <c:if test="${ productFilesSize == 2 }">
	                <c:forEach items="${ productFiles }" var="productFile" varStatus="i">
		                <div class="col-sm-3 pre-image">
		                    <img id="preImage${ i.index + 1}" class="preImage" src="${path1 }/${ productFile.filePath }">
		                </div>
	                </c:forEach>
	                <div class="col-sm-3 pre-image">
	                    <img id="preImage3" class="preImage" src="">
            ...
            <div class="form-group row" style="margin-bottom: 80px !important;">
                ...
                <div class="col-sm-3" style="border-top: 1px solid #e6e6e6">
                    <div class="form-group" style="line-height: 80px; margin-bottom:0px !important;">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="productPurpose1" id="productPurpose1" value="상업용">
                            <label class="form-check-label" for="broadcast">상업용</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="productPurpose2" id="productPurpose2" value="비상업용">
                ...
                <div class="col-sm-2" style="border-top: 1px solid #e6e6e6; line-height: 80px; margin-bottom:0px !important;">
                    <input type="text" class="form-control" id="fileType" name="detailType" value="${ product.detailType }" style="display: inline;" required>
                </div>
                ...
                <div class="col-sm-2" style="border-top: 1px solid #e6e6e6; line-height: 80px; margin-bottom:0px !important;">
                    <input type="text" class="form-control" id="baseSize" name="detailSize" value="${ product.detailSize }" style="display: inline;" placeholder="0000px" required>
                </div>
                <div class="col-sm-6" style="border-top: 1px solid #e6e6e6; line-height: 70px; margin-bottom:0px !important;">
                ...
                <div class="col-sm-8" style="border-top: 1px solid #e6e6e6; line-height: 80px; margin-bottom:0px !important;">
                    <input type="text" class="form-control" id="resolution" name="detailPixel" value="${ product.detailPixel }" style="display: inline; width:160px;" required> dpi
                </div>
                ...
                <div class="col-sm-8" style="border-top: 1px solid #e6e6e6; line-height: 80px; margin-bottom:0px !important;">
                    <input type="number" class="form-control" name="updateCount" min="0" value="${ product.updateCount }" id="revisions" style="display: inline; width:160px;" required> 회
                </div>
                ...
                <div class="col-sm-8" style="border-top: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6; line-height: 80px; margin-bottom:0px !important;">
                    <input type="text" class="form-control" id="workPeriod" name="detailWorkdate" value="${ product.detailWorkdate }" style="display: inline; width:160px;" required>
                </div>
            </div>
                    ...
                    <table class="table table-bordered custom-table" >
                        ...
                        <tbody id="optionList">
                        	<c:forEach items="${ product.payOptionList }" var="payOption">
                       			<c:forEach items="${ payOption.detailOptionList }" var="detailOption" varStatus="i">
                        			<tr id="optionList${ i.index+1 }">
 	                       				<td id="optionList_num${ i.index+1 }" style="text-align:center; line-height:40px;"><input type="checkbox" name="optionCheck" value="${ i.index+1 }" style="display: inline;"></td>
                        				<td><input type="text" class="form-control" id="optionName1" name="optionName" value="${ payOption.optionName }" placeholder="옵션명" required></td>
		                                <td><input type="text" class="form-control" id="optionSelect1" name="detailOptionName" value="${ detailOption.detailOptionName }" placeholder="옵션 선택 항목" required></td>
		                                <td><input type="text" class="form-control option-price" id="detailOptionPrice" name="detailOptionPrice" value="${ detailOption.detailOptionPrice }" placeholder="0" style="text-align:right;" required></td>
		                            <tr>		
                       			</c:forEach>
                        	</c:forEach>
                        </tbody>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="searchTags" name="tags"
                     value="${ productTags }" placeholder="#팬아트#삽화...10개까지 입력 가능. 단어 앞에 # 문자를 넣어주세요">
                </div>
            </div>
            ...
            <div class="smarteditor">
            	...
            	style="width: 100%;" placeholder="내용을 입력해 주세요.">${ product.productContent }</textarea>
            </div>
...
let valid = true;
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
				<button type="button" class="btn-lg btn-primary me-md-2" onclick="submitContents(this);">작품 수정</button>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ path1 }/product/${ product.productNo }" class="btn-lg btn-danger" type="button">취소</a>
			</div>
        </form>
    </div>

...
<body>
    ...
    <div class="container mt-5" >
        <h2>문의 글 수정(Qna)</h2>
        <form action="qnaUpdate" method="post" enctype="multipart/form-data" onsubmit="return submitContents(this)">
             <div class="form-group form-check">
        	 	<input type="checkbox" class="form-check-input" id="secret" name="secret" ${qna.secret == 'Y' ? 'checked' : ''} disabled>
		     ...
		     <div class="form-group">
		         ...
		         <textarea class="form-control" id="editorTxt" name="qnaContent" rows="10">${ qna.qnaContent }</textarea>
		     </div>   
            <div class="form-group">

...
-- QNA 더미 데이터
INSERT INTO QNA (QNA_NO, QNA_TITLE, QNA_CONTENT, QNA_DATE, MEM_ID, SECRET, STATUS, QNA_DELDATE, QNA_CATEGORY)
VALUES (QNA_SEQ.NEXTVAL, '질문 제목1', '질문 내용1', SYSDATE, 'user1', 'N', DEFAULT, NULL, '관리자');
...
CREATE TABLE PRODUCT_QNA (
    ...
    QNA_DELDATE DATE,
    QNA_CATEGORY VARCHAR2(50) NOT NULL,
    CONSTRAINT FK_PRODUCT_QNA_QNA_NO FOREIGN KEY (QNA_NO) REFERENCES QNA (QNA_NO),
    CONSTRAINT FK_PRODUCT_QNA_PRODUCT_NO FOREIGN KEY (PRODUCT_NO) REFERENCES PRODUCT (PRODUCT_NO)
);
ALTER TABLE PRODUCT_QNA DROP CONSTRAINT FK_PRODUCT_QNA_QNA_NO;
ALTER TABLE PRODUCT_QNA ADD PRIMARY KEY (QNA_NO);
commit;
CREATE SEQUENCE PRODUCT_QNA_SEQ START WITH 1 INCREMENT BY 1 NOCACHE;
...
-- ANSWER 더미 데이터
INSERT INTO ANSWER (ANSWER_NO, ANSWER_TITLE, ANSWER_CONTENT, ANSWER_DATE, MEM_ID, QNA_NO, STATUS, ANSWER_DELDATE)
VALUES (ANSWER_SEQ.NEXTVAL, '답변 제목1', '답변 내용1', SYSDATE, DEFAULT, 1, DEFAULT, NULL);
...
CREATE TABLE PRODUCT_ANSWER (
    ...
    PRIMARY KEY (ANSWER_NO),
    FOREIGN KEY (MEM_ID) REFERENCES MEMBER(MEM_ID) ON DELETE CASCADE,
    FOREIGN KEY (QNA_NO) REFERENCES PRODUCT_QNA(QNA_NO) ON DELETE CASCADE
);
...
-- NOTICE 더미 데이터
INSERT INTO NOTICE (NOTICE_NO, NOTICE_TITLE, NOTICE_CONTENT, NOTICE_DATE, MEM_ID, STATUS)
VALUES (NOTICE_SEQ.NEXTVAL, '공지 제목1', '공지 내용1', SYSDATE, DEFAULT, DEFAULT);
INSERT INTO NOTICE (NOTICE_NO, NOTICE_TITLE, NOTICE_CONTENT, NOTICE_DATE, MEM_ID, STATUS)
VALUES (NOTICE_SEQ.NEXTVAL, '공지 제목2', '공지 내용2', SYSDATE, DEFAULT, DEFAULT);
INSERT INTO NOTICE (NOTICE_NO, NOTICE_TITLE, NOTICE_CONTENT, NOTICE_DATE, MEM_ID, STATUS)
VALUES (NOTICE_SEQ.NEXTVAL, '공지 제목3', '공지 내용3', SYSDATE, DEFAULT, DEFAULT);
...
select * from answer;
select * from member;
ALTER TABLE QNA ADD PRODUCT_NO NUMBER;
desc qna;
desc product;
